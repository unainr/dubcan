...
export const HeroSection = () => {
  ...
  <div className="absolute inset-0 bg-linear-to-br from-blue-900/10 via-slate-900/70 to-black/80 z-10" />
  <div className="absolute inset-0 bg-linear-to-b from-transparent via-transparent to-slate-950/50 z-10" />
  <Image 
    width={600}
    height={600}
