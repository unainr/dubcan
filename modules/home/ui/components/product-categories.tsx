...
<section className="py-20 bg-slate-50">
  <div className="container mx-auto px-4">
    <div className="text-center mb-12">
      <div className="inline-flex items-center gap-2 px-5 py-2.5 bg-linear-to-r from-blue-50 to-purple-50 border border-blue-200 text-blue-700 rounded-full text-sm font-semibold mb-4 shadow-sm">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      {productCategories.map((category, index) => (
        <Link key={index} href={category.link} className="group">
          <div className="h-full rounded-xl border-2 border-slate-200 pb-5 hover:border-blue-500/50 hover:shadow-xl hover:shadow-blue-500/10 transition-all duration-500 overflow-hidden bg-white relative">
            ...
            <div className="aspect-4/3 overflow-hidden relative">
              <div className="absolute inset-0 bg-linear-to-t from-slate-900/70 via-transparent to-transparent z-10 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              <Image
              width={900}
              height={900}
              loading='lazy' 
            ...
            <CardHeader className="relative z-10">
              <CardTitle className="text-xl my-3 group-hover:text-blue-600 transition-colors duration-300 flex items-center gap-2">
                {category.name}
